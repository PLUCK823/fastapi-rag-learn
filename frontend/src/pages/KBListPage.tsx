...
const EMPTY_STATE = (
	<div className="text-center py-20 animate-fade-in-up">
		...
		<p
			className="display-text text-base mb-2"
...
export default function KBListPage() {
	...
	const [confirmDelete, setConfirmDelete] = useState<
		(KnowledgeBase | KBDetail) | null
	>(null);
	const [editingKb, setEditingKb] = useState<(KnowledgeBase | KBDetail) | null>(
		null,
	);
	...
	return (
		<div className="max-w-3xl mx-auto">
			...
			<div className="flex items-baseline justify-between mb-8 animate-fade-in-up">
				<div>
					<h1
						className="display-text text-2xl mb-1"
			...
			{/* Create bar */}
			<div
				className="flex gap-3 mb-8 animate-fade-in-up"
								...
								{editingKb?.id === kb.id ? (
									<input
										...
										onBlur={() => {
											if (
												editingName.trim() &&
												editingName.trim() !== editingKb?.name
											) {
												executeRename();
											} else {
												setEditingKb(null);
